        ...
        <div className='h-screen'>
            ...
            <div className="flex justify-center"> {/*de lg pra cima aparece, pra baixo não*/}
                <div className="max-w-screen-2xl w-3/5">
                    ...
                    <div className="bg-verde-nav w-full h-[46rem] mt-10 flex">
                        <div className="w-3/5 p-14">
                            ...
                            <div className="">
                                <div className="flex mt-16 justify-around">
                                    <img src={imagem1} className="h-44" />
                                    <img src={imagem2} className="h-44" />
                                    <img src={imagem3} className="h-44" />
                                </div>
                                <div className="flex mt-16 justify-around">
                                    <img src={imagem4} className="h-44" />
                                    <img src={imagem5} className="h-44" />
                                    <img src={imagem6} className="h-44" />
                                </div>
                            </div>
                        </div>
                        <div className="w-2/4 p-14">
                            <img src={mulher_com_planta} className="w-full h-[39rem]" />
                        </div>
                    </div>
                    ...
                    <div className='flex mt-10 w-full bg-para-sobre-nos'>
                        ...
                        <div className='bg-verde-sobre-nos w-2/6 mr-20 h-[40rem]'>
